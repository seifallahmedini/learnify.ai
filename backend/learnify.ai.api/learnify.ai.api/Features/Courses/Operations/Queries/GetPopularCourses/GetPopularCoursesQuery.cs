...
namespace learnify.ai.api.Features.Courses.Operations.Queries.GetPopularCourses;
...
public class GetPopularCoursesValidator : AbstractValidator<GetPopularCoursesQuery>
{
    public GetPopularCoursesValidator()
    {
        RuleFor(x => x.Page)
            .GreaterThan(0)
...
public class GetPopularCoursesHandler : IRequestHandler<GetPopularCoursesQuery, CourseListResponse>
{
    private readonly ICourseRepository _courseRepository;
    private readonly IUserRepository _userRepository;
    private readonly ICategoryRepository _categoryRepository;

    public GetPopularCoursesHandler(
    ...
    public async Task<CourseListResponse> Handle(GetPopularCoursesQuery request, CancellationToken cancellationToken)
    {
        // Get popular courses sorted by enrollment count
        ...
        var totalCount = await _courseRepository.GetPopularCoursesCountAsync(
            request.CategoryId,
            request.InstructorId,
            request.Level,
            request.MinPrice,
