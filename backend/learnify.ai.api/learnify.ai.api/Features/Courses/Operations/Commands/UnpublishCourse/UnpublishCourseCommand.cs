...
namespace learnify.ai.api.Features.Courses.Operations.Commands.UnpublishCourse;

public record UnpublishCourseCommand(int Id) : ICommand<CourseResponse?>;
...
public class UnpublishCourseHandler : IRequestHandler<UnpublishCourseCommand, CourseResponse?>
{
    private readonly ICourseRepository _courseRepository;
    private readonly IUserRepository _userRepository;
    private readonly ICategoryRepository _categoryRepository;

    public UnpublishCourseHandler(
    ...
    public async Task<CourseResponse?> Handle(UnpublishCourseCommand request, CancellationToken cancellationToken)
    {
