...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Enrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Lesson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Progress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Quiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.QuizAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("learnify.ai.api.Domain.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("learnify.ai.api.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Answer", b =>
                {
                    b.HasOne("learnify.ai.api.Domain.Entities.Question", null)
                        .WithMany()
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Category", b =>
                {
                    b.HasOne("learnify.ai.api.Domain.Entities.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Enrollment", b =>
                {
                    b.HasOne("learnify.ai.api.Domain.Entities.Course", null)
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("learnify.ai.api.Domain.Entities.Payment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Progress", b =>
                {
                    b.HasOne("learnify.ai.api.Domain.Entities.Enrollment", null)
                        .WithMany()
                        .HasForeignKey("EnrollmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("learnify.ai.api.Domain.Entities.Lesson", null)
                        .WithMany()
            ...
            modelBuilder.Entity("learnify.ai.api.Domain.Entities.Question", b =>
                {
                    b.HasOne("learnify.ai.api.Domain.Entities.Quiz", null)
                        .WithMany()
