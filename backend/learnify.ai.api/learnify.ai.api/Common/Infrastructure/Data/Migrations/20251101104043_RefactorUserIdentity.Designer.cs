...
namespace learnify.ai.api.Common.Data.Migrations
{
    ...
    [Migration("20251101104043_RefactorUserIdentity")]
    partial class RefactorUserIdentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("learnify.ai.api.Features.Users.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("learnify.ai.api.Features.Users.Role", null)
                        .WithMany()
